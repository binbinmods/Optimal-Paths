...
namespace OptimalPaths
{
    ...
    public class OptimalPaths
    {
        ...
        public static void AssignSingleGameNodePrefix(ref AtOManager __instance, ref Node _node)
        {
            ...
            if(ForceAllNodes.Value || ForceHighScoring.Value)
            {
            ...
            if (_node.nodeData.CombatPercent != 0 && ForceHighScoring.Value)
            {
            ...
            if (len > 1 && (ForceHighScoring.Value || ForceRareEvents.Value))
            {
