...
namespace OptimalPaths
{
    ...
    public class NodePathCode
    {
        ...
        private static List<string> newZoneNodeIDs = new() { "ulmin_0", "velka_0", "faen_0", "aqua_0", "wolf_0", "voidlow_0", "sen_0","sahti_0","dread_0" };
        private static List<string> bossNodeIDs = new() { "velka_12", "velka_9", "velka_27", "velka_32", "velka_25", "ulmin_56", "pyr_7", "ulmin_38", "secta_5", "sen_33", "sen_27", "sen_31", "sewers_8", "faen_38", "faen_29", "faen_35", "faen_25", "spider_8", "aqua_27", "aqua_35", "forge_6","sahti_62","sahti_36","dread_11"};
